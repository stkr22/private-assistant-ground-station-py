...
class TestClientConfig:
    ...
    def test_valid_client_config(self):
        ...
        config = ClientConfig(
            samplerate=16000, input_channels=1, output_channels=1, chunk_size=1024, room="living_room"
        )
    ...
    def test_client_config_validation_errors(self):
        ...
        with pytest.raises(ValidationError):
            ClientConfig(samplerate="invalid", input_channels=1, output_channels=1, chunk_size=1024, room="test")

    def test_client_config_from_dict(self):
        """Test creating client config from dictionary."""
        data = {"samplerate": 22050, "input_channels": 1, "output_channels": 2, "chunk_size": 2048, "room": "kitchen"}
    ...
    def test_client_config_serialization(self):
        ...
        config = ClientConfig(samplerate=16000, input_channels=1, output_channels=1, chunk_size=1024, room="office")
